...
const UnreturnedServices = () => {
  const navigate = useNavigate()
  return (
    <div className="space-y-4">

      <h2 className="text-lg font-semibold text-slate-700">
        Unreturned Service Calls
      </h2>
      <div className="text-sm text-slate-500">Service Calls / Unreturned Service Calls</div>
...
export default UnreturnedServices